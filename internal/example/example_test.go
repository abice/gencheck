...
func (s *ExampleTestSuite) TestValidateTestStruct_NoValues() {
	expected := gencheck.ValidationErrors{
		...
		gencheck.NewFieldError("Test", "InnerDiveSlice[0]", "dive", fmt.Errorf("validation: field validation failed for 'Inner.EqCSFieldString': is required")),
	...
	underTest := Test{
		...
		InnerDive:         Inner{},
		InnerDivePtr:      &Inner{},
		InnerDiveSlice:    []Inner{{}},
		InnerDiveSlicePtr: []*Inner{{}},
		InnerDiveMap:      map[string]Inner{"test": {}},
		InnerDiveMapPtr:   map[string]*Inner{"test": {}},
	}
...
func (s *ExampleTestSuite) TestValidateTestStruct_Values() {
	...
	underTest := Test{
		...
		InnerDiveSlice:    []Inner{{EqCSFieldString: "something"}},
		InnerDiveSlicePtr: []*Inner{{EqCSFieldString: "something"}},
		InnerDiveMap:      map[string]Inner{"test": {EqCSFieldString: "something"}},
		InnerDiveMapPtr:   map[string]*Inner{"test": {EqCSFieldString: "something"}},
