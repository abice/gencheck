...
func templateCidrTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/cidr.tmpl", size: 2197, mode: os.FileMode(420), modTime: time.Unix(1528248546, 0)}
...
func templateContainsTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/contains.tmpl", size: 1666, mode: os.FileMode(420), modTime: time.Unix(1528247918, 0)}
...
func templateDiveTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/dive.tmpl", size: 600, mode: os.FileMode(420), modTime: time.Unix(1528383264, 0)}
...
func templateUrlTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/url.tmpl", size: 1869, mode: os.FileMode(420), modTime: time.Unix(1528248492, 0)}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"template": &bintree{nil, map[string]*bintree{
		...
		"cidr.tmpl":        &bintree{templateCidrTmpl, map[string]*bintree{}},
		"contains.tmpl":    &bintree{templateContainsTmpl, map[string]*bintree{}},
		"containsany.tmpl": &bintree{templateContainsanyTmpl, map[string]*bintree{}},
		"dive.tmpl":        &bintree{templateDiveTmpl, map[string]*bintree{}},
		"eq.tmpl":          &bintree{templateEqTmpl, map[string]*bintree{}},
